...
def main(s):
    ...
    print (str(sys.getsizeof(sequence))+' | '+str(sys.getsizeof(b"Initialization Sequence - Code 0")))
    print(sequence == b"Initialization Sequence - Code 0")
    print('====================')
    print(list(bytes(sequence)))
    print(list(bytes(b"Initialization Sequence - Code 0")))
    print('====================')
    print(sequence)
